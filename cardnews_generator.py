...
_SEASONAL_TOPICS = {
    "winter": [
        "겨울 한파와 혈액순환 — 손발이 차가운 이유",
        "설날 과식 후 속 편해지는 음식 조합",
        "겨울잠 자는 동물 vs 불면증 현대인",
        "겨울철 비타민D 부족이 우울증을 부른다?",
        "따뜻한 차 한 잔이 체온을 바꾸는 과학",
    ],
    "spring": [
        "춘곤증의 진짜 원인 — 뇌가 보내는 SOS 신호",
        "벚꽃 시즌 알레르기, 꽃가루만의 문제가 아니다",
        "봄나물이 슈퍼푸드인 이유 — 영양 성분 분석",
        "황사·미세먼지 시즌, 폐를 지키는 생활 습관",
        "봄철 다이어트 시작 전 알아야 할 것들",
    ],
    "summer": [
        "여름 보양식, 삼계탕 말고 뭐가 있을까",
        "에어컨병의 정체 — 냉방이 몸에 미치는 영향",
        "열대야 불면증 극복하는 수면 루틴",
        "여름 수분 보충, 물만 마시면 안 되는 이유",
        "자외선과 피부 노화 — 셀럽들의 선케어 비결",
    ],
    "autumn": [
        "가을 건조함이 피부와 호흡기에 미치는 영향",
        "추석 명절 후유증 극복 루틴",
        "환절기 면역력 떨어지는 진짜 이유",
        "가을 우울증 — 일조량과 세로토닌의 관계",
        "단풍 시즌 아웃도어 운동이 건강에 좋은 이유",
    ],
}

# 절기별 특화 주제
_SOLAR_TERM_TOPICS = {
    "입춘": "입춘, 봄맞이 해독 루틴 시작할 타이밍",
    "우수": "우수(雨水) 절기, 건조한 피부에 수분 충전",
    "경칩": "경칩에 깨어나는 건 벌레뿐? 우리 몸도 깨워야 할 때",
    "춘분": "낮밤 같아지는 춘분, 수면 패턴 리셋 방법",
    "청명": "청명, 환절기 알레르기 대비 체크리스트",
    "곡우": "곡우(穀雨), 봄비 시즌 습도와 건강의 관계",
    "입하": "입하, 여름 시작 전 체력 비축 전략",
    "소만": "소만 절기, 초여름 자외선 대비 피부 관리",
    "망종": "망종(芒種), 제철 음식으로 에너지 충전",
    "하지": "하지, 낮이 가장 긴 날의 건강 관리법",
    "소서": "소서 더위 시작, 수분 보충 전략",
    "대서": "대서 폭염, 열사병 예방 생활 수칙",
    "입추": "입추, 가을 대비 면역력 충전 타이밍",
    "처서": "처서, 더위가 가고 건조함이 오는 시기의 피부 관리",
    "백로": "백로 이슬 내리는 절기, 호흡기 건강 체크리스트",
    "추분": "추분, 계절 전환기 수면 리듬 조절법",
    "한로": "한로 찬 이슬 절기, 관절 건강 주의보",
    "상강": "상강 서리 내리는 절기, 혈액순환 체크",
    "입동": "입동, 겨울 준비 — 체온 관리 생활 습관",
    "소설": "소설 첫눈 절기, 면역력 강화 식품 추천",
    "대설": "대설, 큰 눈 내리는 시기 — 뼈·관절 건강",
    "동지": "동지, 가장 긴 밤 — 숙면을 위한 루틴",
    "소한": "소한, 1년 중 가장 추운 절기의 건강 수칙",
    "대한": "대한 강추위, 혈액순환 돕는 생활 팁",
}

# 시의성 있는 트렌드 주제
_TRENDING_TOPICS = [
    "셀럽들이 빠진 '간헐적 단식', 과학적 근거는?",
    "수면 앱 1위 나라 한국, 불면증의 숨은 원인",
    "MZ세대가 열광하는 이너뷰티 시장의 비밀",
    "넷플릭스 보면서 먹는 야식, 몸에 무슨 일이?",
    "커피 대신 한방차·허브티 트렌드, 카페인 프리의 효과",
    "직장인 번아웃 급증, 스트레스가 몸을 망치는 순서",
    "유산균부터 콜라겐까지, 진짜 효과 있는 건?",
    "제철 음식이 영양 보충제보다 나은 이유",
    "하루 1만보 걷기, 진짜 건강에 도움 될까?",
    "SNS에서 유행하는 건강 루틴, 전문가 팩트체크",
]
...
- "넷플릭스 보면서 먹는 야식, 몸에 무슨 일이?" → 야식 습관 → 수면 호르몬 교란 메커니즘
- "셀럽들이 빠진 '간헐적 단식', 진짜 효과는?" → SNS 트렌드 → 오토파지 과학적 근거
- "커피 3잔 이상 마시면 생기는 몸의 변화" → 일상 습관 → 카페인과 코르티솔 관계
- "하루 1만보 걷기, 진짜 건강에 도움 될까?" → 상식 팩트체크 → 최신 운동 연구
- "MZ세대가 영양제에 쏟는 돈, 효과는?" → 소비 트렌드 → 영양 보충제 근거 분석
...
- 의외의 소재 → 건강 인사이트 연결: **+10점** (가장 큰 가산점!)
- "몰랐던 사실" WOW 팩터: +5점
...
_SCRIPT_SYSTEM = """당신은 건강·라이프스타일 카드뉴스 스크립트 작가입니다.

## 카드뉴스 구조 (7장)
#1. 표지: 후킹 헤드라인 15~30자
#2. 내용1: 도입 - 흥미로운 연결/놀라운 사실 30~60자
#3. 내용2: 전개 - 핵심 소재/과학적 근거 30~60자
#4. 내용3: 심화 - 연구 결과/전문가 인용 40~80자 (가장 긴 카드)
