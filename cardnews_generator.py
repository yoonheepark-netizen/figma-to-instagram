...
_MONTHLY_EVENTS = {
    1: [  # 1월
        ...
        {"topic": "새해 첫 달, 공진단으로 시작하는 365일 활력 프로젝트", "tag": "새해", "product": "공진단"},
        {"topic": "1월 한파 경보, 혈관이 가장 위험한 달의 생존법", "tag": "시즌", "product": "우황청심원"},
        {"topic": "세뱃돈 대신 건강? 부모님께 드리는 최고의 선물", "tag": "명절", "product": "경옥고"},
        {"topic": "신년 다이어트, 굶지 않고 살 빠지는 동의보감 처방", "tag": "새해", "product": "없음"},
        {"topic": "겨울 스키장에서 삔 무릎, 관절 회복의 골든타임", "tag": "시즌", "product": "녹용한약"},
        {"topic": "새해 금연 도전 72시간, 몸에 일어나는 변화 타임라인", "tag": "새해", "product": "없음"},
        {"topic": "정초 복날 떡국, 조상님이 챙긴 1월 보양식의 비밀", "tag": "명절", "product": "경옥고"},
        {"topic": "수능 이후 수험생, 1월 컨디션 회복 골든타임", "tag": "시즌", "product": "공진단"},
    ],
    2: [  # 2월
        ...
        {"topic": "일교차 10도 이상, 심장이 보내는 위험 신호 3가지", "tag": "시즌", "product": "우황청심원"},
        {"topic": "설 명절 차례상, 전 기름이 간에 미치는 영향은?", "tag": "설날", "product": "공진단"},
        {"topic": "2월 한파 속 감기 vs 독감, 구분 못하면 위험한 이유", "tag": "시즌", "product": "콜드퀵"},
        {"topic": "겨울 건조한 피부, 안에서부터 촉촉해지는 보습 약재", "tag": "시즌", "product": "경옥고"},
        {"topic": "입학 시즌 아이 체력, 성장기 면역력 세우는 골든타임", "tag": "졸업", "product": "녹용한약"},
        {"topic": "설 연휴 장거리 운전, 허리 디스크 위험 자세 TOP 3", "tag": "설날", "product": "없음"},
        {"topic": "2월 제철 딸기, 비타민C 폭탄이 피부에 미치는 효과", "tag": "시즌", "product": "없음"},
        {"topic": "겨울잠에서 깨어나는 몸, 봄 맞이 해독이 필요한 이유", "tag": "시즌", "product": "경옥고"},
    ],
    3: [  # 3월
        ...
        {"topic": "3월 황사 시즌, 미세먼지가 뇌까지 공격한다?", "tag": "시즌", "product": "공진단"},
        {"topic": "개학 후 아이 감기 폭발, 소아 면역력 세우는 법", "tag": "시즌", "product": "콜드퀵"},
        {"topic": "봄철 졸음운전 사고 급증, 15분 낮잠의 과학적 효과", "tag": "시즌", "product": "공진단"},
        {"topic": "화이트데이 사탕, 설탕이 뇌에 미치는 48시간의 여정", "tag": "이벤트", "product": "없음"},
        {"topic": "봄 알레르기 코막힘, 약 없이 10초 해결하는 지압법", "tag": "시즌", "product": "없음"},
        {"topic": "3월 새 학기 시험 스트레스, 집중력 높이는 한약재 3가지", "tag": "시즌", "product": "총명공진단"},
        {"topic": "봄 피크닉 도시락, 식중독 예방하는 온도 관리법", "tag": "시즌", "product": "까스퀵"},
        {"topic": "겨우내 굳은 관절, 봄 스트레칭 5분 루틴", "tag": "시즌", "product": "녹용한약"},
    ],
    4: [  # 4월
        ...
        {"topic": "봄비 오는 날 관절 통증, 기압과 관절의 숨겨진 관계", "tag": "시즌", "product": "녹용한약"},
        {"topic": "꽃가루 폭탄 4월, 눈·코·목 3단 방어 전략", "tag": "시즌", "product": "없음"},
        {"topic": "4월 벚꽃 나들이, 걷기 운동이 우울증을 이기는 원리", "tag": "시즌", "product": "없음"},
        {"topic": "봄철 나른함 vs 만성피로, 구분하는 체크리스트 5가지", "tag": "시즌", "product": "공진단"},
        {"topic": "4월 제철 쑥, 동의보감 최고의 해독 약재를 먹는 법", "tag": "시즌", "product": "경옥고"},
        {"topic": "중간고사 시즌, 뇌에 산소 공급하는 10분 루틴", "tag": "시즌", "product": "총명공진단"},
        {"topic": "장마 전 마지막 캠핑 시즌, 야외 활동 관절 관리법", "tag": "시즌", "product": "녹용한약"},
        {"topic": "환절기 탈모 급증, 두피가 보내는 SOS 신호 읽는 법", "tag": "시즌", "product": "경옥고"},
    ],
    5: [  # 5월
        ...
        {"topic": "5월 가정의 달, 부모님 건강검진 꼭 챙겨야 할 항목 5가지", "tag": "가정의달", "product": "공진단"},
        {"topic": "어린이날 아이 간식, 성장에 독이 되는 첨가물 체크", "tag": "가정의달", "product": "녹용한약"},
        {"topic": "5월 자외선 급증, 봄 햇살이 여름보다 위험한 이유", "tag": "시즌", "product": "없음"},
        {"topic": "가정의 달 효도 여행, 부모님 무릎 관절 지키는 여행법", "tag": "가정의달", "product": "녹용한약"},
        {"topic": "5월 제철 두릅, 산삼 못지않은 봄 보약의 효능", "tag": "시즌", "product": "경옥고"},
        {"topic": "석가탄신일 사찰음식, 채식이 장 건강에 미치는 72시간", "tag": "이벤트", "product": "까스퀵"},
        {"topic": "5월 황사 2차 공습, 기관지 약한 사람이 꼭 먹어야 할 것", "tag": "시즌", "product": "경옥고"},
        {"topic": "봄 소풍 도시락 식중독, 30도 넘으면 2시간이 한계", "tag": "시즌", "product": "까스퀵"},
    ],
    6: [  # 6월
        ...
        {"topic": "6월 장마 시작, 습기가 관절을 공격하는 메커니즘", "tag": "장마", "product": "녹용한약"},
        {"topic": "현충일 등산, 6월 더위 속 등산 안전 수칙 5가지", "tag": "이벤트", "product": "녹용한약"},
        {"topic": "여름 앞둔 다이어트, 굶는 것보다 효과적인 방법 3가지", "tag": "시즌", "product": "없음"},
        {"topic": "장마철 빨래 곰팡이, 호흡기에 미치는 숨은 위험", "tag": "장마", "product": "경옥고"},
        {"topic": "6월 제철 매실, 여름 배탈 예방하는 할머니 지혜의 과학", "tag": "시즌", "product": "까스퀵"},
        {"topic": "기말고사 시즌, 시험 불안이 배를 아프게 하는 이유", "tag": "시즌", "product": "까스퀵"},
        {"topic": "여름 에어컨 틀기 전, 폐를 지키는 필터 관리법", "tag": "시즌", "product": "경옥고"},
        {"topic": "6월 모기 출몰, 모기 물린 후 긁으면 안 되는 과학적 이유", "tag": "시즌", "product": "없음"},
    ],
    7: [  # 7월
        ...
        {"topic": "7월 폭염 경보, 열사병 vs 일사병 구별과 응급 대처법", "tag": "시즌", "product": "없음"},
        {"topic": "복날 삼계탕 외에도? 동의보감 여름 보양식 베스트 5", "tag": "삼복", "product": "경옥고"},
        {"topic": "여름 수영장 물, 눈·귀·피부가 위험한 이유", "tag": "시즌", "product": "없음"},
        {"topic": "냉면 한 그릇 칼로리, 여름 국수의 배신", "tag": "시즌", "product": "없음"},
        {"topic": "7월 자외선 피크, SPF 50도 못 막는 자외선의 정체", "tag": "시즌", "product": "없음"},
        {"topic": "여름 과일 수박, 먹기 전 알아야 할 당뇨 위험 수치", "tag": "시즌", "product": "없음"},
        {"topic": "7월 냉방병 주의보, 에어컨 온도 1도 차이의 건강 영향", "tag": "시즌", "product": "콜드퀵"},
        {"topic": "여름 캠핑 식중독, 바베큐 고기 온도계가 필수인 이유", "tag": "시즌", "product": "까스퀵"},
    ],
    8: [  # 8월
        ...
        {"topic": "8월 잔여 더위, 늦더위에 지친 몸 회복하는 보양 전략", "tag": "시즌", "product": "경옥고"},
        {"topic": "여름 해수욕 후 귀 통증, 외이도염 예방 3단계", "tag": "휴가", "product": "없음"},
        {"topic": "8월 야외 활동, 벌 쏘임 응급처치와 알레르기 쇼크 대비법", "tag": "시즌", "product": "없음"},
        {"topic": "개학 앞둔 아이 수면 리듬, 2주 전부터 준비해야 하는 이유", "tag": "시즌", "product": "공진단"},
        {"topic": "여름 끝자락 식중독 주의, 8월이 가장 위험한 달", "tag": "시즌", "product": "까스퀵"},
        {"topic": "태풍 시즌, 기압 변화가 두통을 일으키는 과학적 이유", "tag": "시즌", "product": "없음"},
        {"topic": "8월 늦더위 불면증, 수면 질을 높이는 5가지 환경 세팅", "tag": "시즌", "product": "공진단"},
        {"topic": "방학 끝 아이 체력 점검, 성장기 보약 타이밍은?", "tag": "시즌", "product": "녹용한약"},
    ],
    9: [  # 9월
        ...
        {"topic": "추석 차례상 나물, 고사리·도라지·시금치의 약효", "tag": "추석", "product": "경옥고"},
        {"topic": "9월 환절기, 일교차 10도가 면역력에 미치는 영향", "tag": "시즌", "product": "콜드퀵"},
        {"topic": "추석 연휴 과식, 명절 소화불량 탈출 3단계", "tag": "추석", "product": "까스퀵"},
        {"topic": "가을 등산 시즌, 단풍 산행 전 체크해야 할 관절 상태", "tag": "시즌", "product": "녹용한약"},
        {"topic": "9월 제철 대추, 동의보감이 말하는 '대추 3알의 기적'", "tag": "시즌", "product": "경옥고"},
        {"topic": "환절기 감기 vs 코로나, 2024 구분법 총정리", "tag": "시즌", "product": "콜드퀵"},
        {"topic": "가을 우울증 시작되는 9월, 세로토닌을 올리는 식품 5가지", "tag": "시즌", "product": "없음"},
        {"topic": "추석 귀성길 장시간 운전, 허리·목 지키는 스트레칭", "tag": "추석", "product": "없음"},
    ],
    10: [  # 10월
        ...
        {"topic": "10월 단풍 등산, 발목 접질렸을 때 RICE 응급처치", "tag": "시즌", "product": "녹용한약"},
        {"topic": "가을 건조 시즌, 기침이 3주 이상이면 의심해야 할 것", "tag": "시즌", "product": "경옥고"},
        {"topic": "10월 독감 예방접종 시즌, 맞아야 할 사람 vs 주의할 사람", "tag": "시즌", "product": "콜드퀵"},
        {"topic": "가을 전어 시즌, 오메가3가 풍부한 제철 생선의 효능", "tag": "시즌", "product": "없음"},
        {"topic": "10월 핑크리본 유방암 인식의 달, 자가검진 방법 총정리", "tag": "기념일", "product": "없음"},
        {"topic": "할로윈 사탕 대란, 아이 충치 예방하는 간식 대체법", "tag": "할로윈", "product": "없음"},
        {"topic": "가을 낙엽 산책, 30분 걷기가 혈당을 잡는 원리", "tag": "시즌", "product": "없음"},
    ],
    11: [  # 11월
        ...
        {"topic": "수능 끝 수험생, 시험 후 면역력 붕괴를 막는 회복법", "tag": "수능", "product": "공진단"},
        {"topic": "11월 첫 한파, 갑작스런 추위에 혈관이 반응하는 방식", "tag": "시즌", "product": "우황청심원"},
        {"topic": "김장 허리 통증, 쪼그려 앉는 자세가 디스크를 부른다", "tag": "김장", "product": "녹용한약"},
        {"topic": "가을 끝자락 비타민D 부족, 11월부터 챙겨야 하는 이유", "tag": "시즌", "product": "없음"},
        {"topic": "11월 제철 홍시, 숙취 해소에 감이 좋은 과학적 이유", "tag": "시즌", "product": "없음"},
        {"topic": "수능 전 긴장과 복통, 스트레스가 장에 미치는 영향", "tag": "수능", "product": "까스퀵"},
        {"topic": "11월 난방 시작, 건조한 실내 공기가 호흡기에 미치는 영향", "tag": "시즌", "product": "경옥고"},
        {"topic": "블랙프라이데이 건강식품 쇼핑, 꼭 체크할 성분표 읽기법", "tag": "이벤트", "product": "없음"},
    ],
    12: [  # 12월
        ...
        {"topic": "12월 한파 속 심장마비 급증, 새벽 운동이 위험한 이유", "tag": "시즌", "product": "우황청심원"},
        {"topic": "연말 회식 폭탄, 간이 처리할 수 있는 알코올의 한계", "tag": "연말", "product": "공진단"},
        {"topic": "크리스마스 선물 추천, 부모님 건강 선물 베스트 5", "tag": "크리스마스", "product": "경옥고"},
        {"topic": "겨울 노로바이러스 주의보, 굴·조개 안전하게 먹는 법", "tag": "시즌", "product": "까스퀵"},
        {"topic": "연말 번아웃, 1년의 피로가 한꺼번에 몰려오는 이유", "tag": "연말", "product": "공진단"},
        {"topic": "12월 제철 귤, 껍질까지 약재로 쓰는 동의보감 활용법", "tag": "시즌", "product": "경옥고"},
        {"topic": "새해 전야 불면증, 연말 흥분이 수면 리듬을 깨는 원리", "tag": "연말", "product": "없음"},
    ],
}
...
_SEASONAL_TOPICS = {
    "winter": [
        ...
        "겨울 한파 속 혈압 급등, 아침 기상 시 주의할 점",
        "핫초코 한 잔의 과학, 카카오가 혈관에 미치는 효과",
        "겨울 실내 건조, 가습기 없이 습도 올리는 생활 꿀팁",
        "스키·보드 시즌, 무릎 부상 예방하는 준비 운동 5가지",
        "겨울 감기 vs 독감 vs 코로나, 초기 증상 구별법",
        "따뜻한 국물 요리, 겨울 면역력 올리는 약선 레시피 3가지",
        "겨울철 정전기, 건조한 피부가 보내는 수분 SOS",
        "추운 날 따뜻한 차 한잔, 대추차·생강차·계피차 효능 비교",
        "겨울 운동 딜레마, 실내 vs 실외 칼로리 소모 차이",
        "연말 과음 시즌, 간이 회복하는 데 걸리는 시간은?",
    ],
    "spring": [
        ...
        "봄 피크닉 시즌, 야외 활동이 세로토닌을 올리는 원리",
        "봄철 미세먼지 vs 초미세먼지, 진짜 위험한 건 어느 쪽?",
        "환절기 피부 트러블, 안에서부터 잡는 한방 스킨케어",
        "봄 제철 딸기, 비타민C 함량이 레몬보다 높다?",
        "4월 벚꽃 산책, 하루 30분 걷기가 뇌를 바꾸는 과학",
        "봄 새싹 비빔밥, 발아 식물의 숨겨진 영양소 분석",
        "꽃가루+황사 더블 펀치, 봄철 호흡기 지키는 3단계",
        "봄 다이어트, 기초대사량을 올리는 식이요법 vs 운동",
        "환절기 면역력 저하, 비타민C·D·아연 최적 조합은?",
        "봄 날씨 들쭉날쭉, 기온 변화에 자율신경이 반응하는 법",
    ],
    "summer": [
        ...
        "장마철 습한 날, 관절이 아픈 진짜 이유는 기압?",
        "여름 자외선이 피부 노화의 80%를 차지한다?",
        "아이스 아메리카노 3잔, 카페인이 여름 탈수를 부른다",
        "바다 수영 vs 수영장, 운동 효과가 다른 과학적 이유",
        "여름 회·초밥 식중독, 비브리오균 예방하는 온도 관리법",
        "폭염 속 야외 운동, 열사병 전조증상 알아채는 체크리스트",
        "여름 제철 복숭아, 한의학에서 말하는 의외의 효능",
        "냉방병 vs 감기, 증상은 비슷한데 치료법이 다른 이유",
        "여름 불면증, 침실 온도 1도가 수면 질을 좌우한다",
        "장마 후 폭염, 습도+온도 조합이 체감온도를 올리는 법",
    ],
    "autumn": [
        "공진단처럼 꽉 찬 추석 보내세요!",
        ...
        "가을 독서 시즌, 책 읽기가 치매 예방에 효과적인 이유",
        "환절기 코막힘, 비염 vs 감기 구별하는 3가지 포인트",
        "가을 제철 배, 기침·가래에 배즙이 통하는 과학적 근거",
        "10월 일교차 15도, 심혈관 사고가 급증하는 계절",
        "가을 피부 건조, 보습제만으론 부족한 이유와 대안",
        "환절기 탈모 시즌, 하루 100개 이상 빠지면 의심해야 할 것",
        "가을 캠핑 시즌, 야외 취침 시 저체온증 예방법",
        "추석 이후 체중 증가, 3kg 빼는 데 필요한 현실적 기간",
        "가을 운동의 황금기, 선선한 날씨가 운동 효율을 높이는 이유",
        "11월로 가는 환절기, 수면 리듬이 흐트러지는 과학적 이유",
    ],
}
...
_TRENDING_TOPICS = [
    ...
    "간헐적 단식 16:8, 정말 살이 빠지는 건 언제부터?",
    "필라테스 vs 요가, 어떤 운동이 내 몸에 맞을까?",
    "ChatGPT 시대, AI가 의사를 대체할 수 있을까?",
    "5분 명상이 뇌 구조를 바꾼다? MRI로 본 과학적 증거",
    "오메가3 vs 크릴오일, 진짜 효과 차이 총정리",
    "비건 열풍, 채식만으로 충분한 단백질을 얻을 수 있나?",
    "10초 스쿼트 챌린지, SNS 유행 운동의 진짜 효과",
    "프로바이오틱스 전쟁, 유산균 숫자가 중요한 게 아니다?",
    "수면 앱 시대, 수면 추적이 오히려 불면증을 유발한다?",
    "애플워치 심전도, 웨어러블이 생명을 구한 실제 사례",
    "글루텐프리 열풍, 밀가루를 끊으면 정말 건강해질까?",
    "냉수 샤워 챌린지, 찬물이 면역력을 높이는 과학적 원리",
    "탕후루 열풍 그 이후, 설탕 코팅이 치아에 미치는 영향",
    "런닝크루 문화, 같이 뛰면 혼자보다 30% 더 건강해진다?",
    "마라탕 중독의 과학, 매운맛이 뇌에 미치는 도파민 효과",
    "손흥민의 체력 비결, 프로 선수 컨디션 관리법에서 배우다",
    "제로슈거 음료의 함정, 인공감미료가 장내 세균을 바꾼다?",
    "홈트 유튜브 시대, 잘못된 자세가 부상을 부르는 5가지 동작",
    "아침형 인간 vs 저녁형 인간, 유전자가 수면 패턴을 결정한다?",
    "K-뷰티 글로벌 열풍, 한방 화장품이 해외에서 주목받는 이유",
]
...
def _fetch_naver_trends() -> list[dict]:
    """네이버 실시간 검색 트렌드 (signal.bz API, 인증 불필요)
    ...
    try:
        ...
        logger.warning(f"네이버 트렌드(signal.bz) 가져오기 실패: {e}")
...
def suggest_topics(include_news: bool = True, refresh_seed: int = 0) -> list[dict]:
    ...
    # 1) 월별 이벤트/트렌드 주제 (최우선) — 확장된 풀에서 4개 샘플
    ...
    # 6) 구글 검색 트렌드 + 7) X 트렌드 + 8) 네이버 트렌드 — 일반 키워드는 건강 주제로 변환
...
## 임무
{domain} 분야에서 라이프스타일·건강 브랜드 '수(thesoo)'의 Instagram 카드뉴스 아이디어 2개를 제안하세요.
...
의외의 소재에서 출발해 유용한 인사이트로 연결하는 방식이 최고 점수를 받아요.

## 건강/제품 연결 규칙 (매우 중요!)
- 주제가 건강과 **자연스럽게** 연결되면 → 건강 인사이트 + 제품 배치 OK
- 주제가 건강과 **억지로만** 연결되면 → 건강 연결 없이 순수 정보/교양 콘텐츠로 작성
- product 필드: 자연스러운 연결이 가능할 때만 제품명, 아니면 반드시 "없음"
- "없음"은 감점이 아닙니다. **자연스러운 콘텐츠가 억지 제품 배치보다 훨씬 우수합니다**
- 예: "봄철 벚꽃 명소 TOP 5" → 건강과 무관 → product: "없음", 순수 라이프스타일 콘텐츠로

## 스크립트 연계 규칙 (매우 중요!)
- content1~5는 이후 스크립트 생성의 **뼈대**가 됩니다
- 각 content는 해당 카드의 핵심 메시지를 **정확하고 구체적으로** 담아야 합니다
- 스크립트 생성 시 이 content를 그대로 확장하므로, 모호하거나 추상적인 표현 금지
- 예) 좋음: "영조는 83세까지 살며 경옥고를 251번 처방받았어요" (구체적 팩트)
- 예) 나쁨: "역사 속 건강 비결을 알아볼까요?" (모호, 스크립트에서 변질됨)
...
4. **콘텐츠 완성도**: content1→5가 하나의 이야기로 자연스럽게 흘러야 함 (억지 건강/제품 연결보다 중요!)
...
## 톤 규칙
- '광고'가 아니라 '교양 콘텐츠'. "이거 재밌네!" 반응이 목표.
- 내용1~4: 순수 정보/스토리. 제품 판매 느낌 절대 금지.
- 내용5: 여운을 남기는 비유형 마무리 (CTA 금지). 제품 연결이 자연스러울 때만 브랜드명 1회.
...
_BATCH_SYSTEM = """당신은 라이프스타일·건강 브랜드 '수(thesoo)'의 콘텐츠 기획팀입니다.
...
## 건강/제품 연결 규칙 (매우 중요!)
- 주제가 건강과 **자연스럽게** 연결되면 → 건강 인사이트 + 제품 배치 OK
- 주제가 건강과 **억지로만** 연결되면 → 건강 연결 없이 순수 정보/교양 콘텐츠로
- product: 자연스러운 연결이 가능할 때만 제품명, 아니면 반드시 "없음"
- **자연스러운 콘텐츠가 억지 제품 배치보다 훨씬 우수합니다**

## 스크립트 연계 규칙 (매우 중요!)
- content1~5는 이후 스크립트 생성의 **뼈대**입니다. 구체적 팩트/메시지를 담으세요.
- 모호하거나 추상적인 content 금지 → 스크립트에서 변질됩니다.
...
3. 콘텐츠 완성도: content1→5가 하나의 이야기로 자연스럽게 흘러야 함 (억지 건강/제품 연결보다 중요!)
...
### 4. 콘텐츠완성도 (20점)
- 20점: content1→5가 하나의 이야기로 완결, 주제와 스크립트 완벽 일치, 문맥이 자연스러움
- 15점: 흐름은 있지만 일부 카드가 주제에서 살짝 벗어남
- 10점: 건강이나 제품을 억지로 끼워 넣어 문맥이 깨짐
- 5점: 주제와 content가 따로 놀고 일관성이 없음
...
- 의외의 소재 → 유용한 인사이트 연결: **+10점** (예: 고양이→콜레라→건강문화)
- 구체적 숫자/역사 기록 인용: **+5점** (예: 영조 83세, 251번, 카보넨 공식)
- 팝컬쳐 레퍼런스 활용: **+5점** (예: 엘사, 골룸, 트럼프)
- 브랜드/제품이 자연스럽게 연결됨: **+5점** (억지가 아닌 경우에만)

## 감점
- 광고 카피 느낌: -10점
- **건강/제품 억지 연결**: -10점 (주제와 무관하게 건강/제품을 끼워 넣은 경우)
...
```json
[
  {{"index": 0, "hook": 18, "story": 16, "empathy": 17, "coherence": 18, "viral": 19, "bonus": 10, "penalty": 0, "total": 98, "comment": "영조 251번 숫자 후킹 + 경옥고 역사 연결이 자연스러움, content 흐름 완벽"}},
  {{"index": 1, "hook": 12, "story": 14, "empathy": 13, "coherence": 8, "viral": 11, "bonus": 0, "penalty": 10, "total": 48, "comment": "헤드라인 평이, 건강/제품 연결 억지스러워 문맥이 깨짐"}}
]
```"""
...
def evaluate_ideas(ideas: list[dict]) -> list[dict]:
    ...
    if not scores and raw:
        ...
        retry_system = (
            ...
            '```json\n[{"index":0,"hook":15,"story":14,"empathy":16,"coherence":15,"viral":13,"bonus":0,"penalty":0,"total":73,"comment":"질문형 후킹 양호, content 흐름 자연스러움"}]\n```'
        )
...
## 최우선 규칙: 아이디어 충실 재현!
- 아래 주어진 아이디어의 content1~5가 이 스크립트의 **뼈대**입니다
- 각 content의 핵심 메시지를 **반드시 유지**하면서 30~60자 문장으로 확장하세요
- 아이디어에 없는 새로운 주장이나 방향 전환을 하지 마세요
- 아이디어의 product가 "없음"이면 제품/브랜드 언급 없이 순수 콘텐츠로 완성하세요
- 전체 스크립트의 문맥과 맥락이 자연스럽고 일관되어야 합니다
...
_DESC_SYSTEM = """당신은 라이프스타일·건강 브랜드 '수壽(thesoo.co)'의 전문 콘텐츠 마케터입니다.
주어진 주제에 대한 논문·보도자료·전문 기사의 내용을 참고하여 인스타그램 캡션을 작성합니다.
...
4. **마무리**: 수壽 제품과 자연스러운 연결이 가능하면 포함 (1문장). 연결이 억지스러우면 주제에 맞는 감성적 마무리로 대체.
